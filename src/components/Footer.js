      ...
      <div className="container px-8 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          ...
          <span>
            ...
            by <span className="text-gray-700 font-medium">Mingu Kang. </span>
            Code at{' '}
            <a
              href="https://github.com/min-9/react-code-editor"
              target="__blank"
...
/**
<div className="sticky h-8 bottom-0 px-2 py-1 flex items-center justify-center w-full text-xs text-gray-500 ">
      <span>
        Built with{' '}
        <svg
          height="2500"
